...
///<AutoGeneratedContent id="ObjectDataAreaMap">
	...
	OBJDATAAREA_VALUE(ADI_Module1Internal, m_Internal)
///</AutoGeneratedContent>
END_OBJDATAAREA_MAP()
...
HRESULT CModule1::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	...
	m_Internal.Counter1 = m_Inputs.Counter1;
	m_Internal.Counter2 = m_Inputs.Counter2;

	
	m_Outputs.ToX = (m_Outputs.ToX + 1) % 200;
