...
IMPLEMENT_IPERSIST_LIB(CModule1, VID_cpp, CID_cppCModule1)
...
///<AutoGeneratedContent id="SetObjectParameterMap">
	...
	SETOBJPARA_VALUE(PID_Module1Data, m_Data)
...
///<AutoGeneratedContent id="GetObjectParameterMap">
	...
	GETOBJPARA_VALUE(PID_Module1Data, m_Data)
...
///<AutoGeneratedContent id="ObjectParameterWatchMap">
	OBJPARAWATCH_VALUE(PID_Module1Data, m_Data)
///</AutoGeneratedContent>
...
HRESULT CModule1::SetObjStatePS(PTComInitDataHdr pInitData)
{
	...
	m_log.SetContextId(m_ContextAdsPort);
...
HRESULT CModule1::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	...
	if (m_Data[0] != 0 && m_Data[0] != m_prevValue)
	{
		m_prevValue = m_Data[0];
		m_log.LogSequenceStart(1, 0);
		m_log.LogSequenceStop(1, 0);
	}
	if (m_Outputs.Data[0] != 0 && m_Outputs.Data[0] != m_prevValue2)
	{
		m_prevValue2 = m_Outputs.Data[0];
		m_log.LogSequenceStart(2, 0);
		m_log.LogSequenceStop(2, 0);
	}
